...
OOM의 **OPIc 수험 가이드**는 소개·등급, 회원·신청·응시료, 신분증·입실·시험 진행, 성적·인증서·쿠폰의 네 하위 페이지로 구성됩니다. 응시료·일정·마감·수험 준비물처럼 변동 가능한 정보는 반드시 [OPIc 공식 사이트](https://www.opic.or.kr/opics/jsp/view/index.jsp)의 최신 안내를 확인합니다.
